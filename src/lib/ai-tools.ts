 ...
 * Sourced from: https://github.com/abraham-yusuf/web3ai-hub/blob/main/prisma/seed.ts
 * Static file-based data for MDX-only project (no database)
 */
...
export function getAllCategories(): string[] {
  return [...new Set(aiTools.map((tool) => tool.category))].sort()
}
